					...
					<div className="row">
						<div className="col-md-12">
							<Breadcrumb>
								...
								<Breadcrumb.Item><Link to="/best-practice">TOOLS</Link></Breadcrumb.Item>
					...
					{this.state.article !== null && this.state.article.content !== undefined
						...
						? <div className="row row-spaced">
							...
							<div className="col-md-4 side-info">
								<div className="row">
									<div className="col-md-12">
										<div className="h8 blue-text">Share the tool</div>
									</div>
								...
								<div className="row">
									<div className="col-md-12">
										<div className="h8 blue-text">Related tools</div>
									</div>
